...
In UX Studio, go to File > Import.
Select Existing Projects in workspace and click Next.
Select Select archive file and browse to the compressed cartridge file.
Click Finish to import the cartridge.
Link the cartridge to your active DigitalServer connection.
Activating Cartridges in Business Manager
Log into Business Manager.
Go to Administration > Sites > Manage Sites.
Select Manage the Business Manager site.
In Cartridges add bc_comet.
Click Apply.
Importing Metadata
Compress the comet-meta-import folder into a ZIP file.
Go to Administration > Site Development > Site Import & Export.
Select Import: Upload Archive > Local > Choose File.
Upload the comet-meta-import.zip file.
Select the archive and click Import.
...
Comet Support Email
Comet GitHub
Let me know if you would like me to modify or expand this integration documentation further.
