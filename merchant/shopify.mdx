...
click on **Store settings** from the Home Page or tabs on the left
    ...
    ![Untitled](/images/shopify/Untitled.png)

    
2. Add Store Information and URL

    To set up a Shopify store in the dashboard, please enter the basic details of your store and click next:
    - Add your store name
    - Add the store URL e.g., the URL of your Shopify store
    - Click next

    ![#2_Shopify_Step 2_1. Next.png](/images/shopify/2_Shopify_Step_2_1._Next.png)

3. Connect e-commerce platform

    Select **Shopify** as your e-commerce platform and click next

    ![#3_Shopify_Step 3.png](/images/shopify/3_Shopify_Step_3.png)
...
1. From your Shopify main dashboard, navigate to → **Settings**
    ...
    ![Untitled](/images/shopify/Untitled_1.png)
    
2. From Settings, navigate to → **Apps and sales channels**
    
    ![Untitled](/images/shopify/Untitled_2.png)
    
3. Navigate to → **Develop Apps**
    
    ![Untitled](/images/shopify/Untitled_3.png)
    
4. Click **Create an app**
    
    ![Untitled](/images/shopify/Untitled_4.png)
...
is the default selected user.
    ...
    ![Untitled](/images/shopify/Untitled_5.png)
...
the **Admin API integration** section and click **Configure.**
    ...
    ![Untitled](/images/shopify/Untitled_6.png)
    
2. Next, go to *Admin API access scopes* and select the required scopes.
...
3. Once completed, click **Save** to apply changes
    
    ![Untitled](/images/shopify/Untitled_7.png)
...
the **Storefront API configuration** section and click **Configure**.
    ...
    ![Untitled](/images/shopify/Untitled_8.png)
...
3. Click **Save** to apply changes
    ...
    ![Untitled](/images/shopify/Untitled_9.png)
...
settings.
    ...
    ![Untitled](/images/shopify/Untitled_11.png)
...
`API secret key`
    ...
    ![Untitled](/images/shopify/Untitled_12.png)
    
    ![#18_Shopify_Step 4_2. Move to Shopify store admin.png](/images/shopify/18_Shopify_Step_4_2._Move_to_Shopify_store_admin.png)
...
![#19_Shopify_Step 4_5. Add Myshopify URL.png](/images/shopify/19_Shopify_Step_4_5._Add_Myshopify_URL.png)
...
Settings** and it will be shown on the top left.
    ...
    ![Untitled](/images/shopify/Untitled_13.png)
...
![#20_Shopify_Step 4_6. Click submit your credentials to apply your changes.png](/images/shopify/20_Shopify_Step_4_6._Click_submit_your_credentials_to_apply_your_changes.png)
