...
2. Next, go to *Admin API access scopes* and select the required scopes.Here look for the list of keywords listed below to validate the relevant necessary scopes - see example screenshot for “Product”:![#10\_Shopify\_Step 4\_2. b. ii..png](/images/shopify/10_Shopify_Step_4_2._b._ii..png)To successfully connect Comet to your Shopify store, find and select the
