...
2. Here, find and select the following 6 access scopes:

   * **Checkout:** `unauthenticated_write_checkouts`, `unauthenticated_read_checkouts`

   * **Customers:** `unauthenticated_write_customers`, `unauthenticated_read_customers`
